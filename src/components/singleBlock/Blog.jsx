...
const Blog = ({blog}) => {
    const {title,cover,reading_time,author_img,author,posted_date,hash_tags}=blog
  return (
    <div className='mb-20'>
...
<button className='ml-1 text-gray-400 text-2xl'><IoBookmarkSharp className='' /></button>
